...
All rules presented in this document have been made available to the OSA development team for integration. It has been agreed that the whole set of rules will be included in the OSA 4.7 installation package. Nonetheless, only the general rules without requirements will be switched on by default in the standard OSA 4.7 installation. This approach will avoid the indiscriminate use of rules created for specific environments (which should be deployed only with the operator confirming the presence of a matching monitored system).
