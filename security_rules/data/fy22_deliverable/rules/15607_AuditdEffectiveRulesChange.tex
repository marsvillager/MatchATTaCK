...
\section{Auditd Effective Rules Change}
\label{15607}
%\addcontentsline{toc}{section}{\protect\numberline{}(Tool)}%

\openup 1em

\textbf{Full name:} Auditd effective rules change\hrulefill \\
...
This rule detects changes of the configuration of auditd, i.e. the modification, addition or deletion of effective auditd rules
