...
\section{Auditd Etc Group Modification}
\label{15605}
%\addcontentsline{toc}{section}{\protect\numberline{}(Tool)}%

\openup 1em

\textbf{Full name:} Auditd etc group modification\hrulefill \\
...
This rule detects the modification of the /etc/group and /etc/gshadow files which contain the group account information and the secure group account information, respectively. These files are changed when a group is modified, added or deleted or the password of a group is changed.
