...
\section{Auditd Generic File Write}
\label{15651}
%\addcontentsline{toc}{section}{\protect\numberline{}(Tool)}%

\openup 1em

\textbf{Full name:} Auditd generic file write\hrulefill \\
...
This rule detects the writing action on a given file or directory.
