...
\section{Auditd Passwd Command}
\label{15600}
%\addcontentsline{toc}{section}{\protect\numberline{}(Tool)}%

\openup 1em

\textbf{Full name:} Auditd passwd command\hrulefill \\
...
This rule detects the execution of the /usr/bin/passwd binary that is used to change the password of a user account.
