...
\section{Auditd Generic File Read}
\label{15650}
%\addcontentsline{toc}{section}{\protect\numberline{}(Tool)}%

\openup 1em

\textbf{Full name:} Auditd generic file read\hrulefill \\
...
This rule detects the reading action on a given file or directory.
