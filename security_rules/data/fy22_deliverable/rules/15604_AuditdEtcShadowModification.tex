...
\section{Auditd Etc Shadow Modification}
\label{15604}
%\addcontentsline{toc}{section}{\protect\numberline{}(Tool)}%

\openup 1em

\textbf{Full name:} Auditd etc shadow modification\hrulefill \\
...
This rule detects the modification of the /etc/shadow file which contains the encrypted passwords for all user accounts, i.e. when the password of a user account is changed.
